...
export function RecordButton({ onTranscriptionComplete, onTranscribing, disabled = false }: RecordButtonProps) {
    ...
    try {
      ...
      mediaRecorder.onstop = async () => {
        ...
        try {
          ...
          // Create form data to send to our secure API endpoint
